    ...
    return (
        <Link href={href}>
            <div className={`cursor-pointer flex item-center ${
                ...
                isActive ? "bg-blue200 text-white" : ""
            }`}>
    ...
    return (
        <div className={sidebarClassNames}>
            <div className={`flex gap-3 justify-between md:justify-normal items-center pt-8 ${isSidebarCollapsed ? "px-5" : "px-8"}`}>
                <div>logo</div>
                <h1 className={`${isSidebarCollapsed ? "hidden" : "block"} font-extrabold text-2xl`}>EMASUPPIES</h1>
            ...
            <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
                <p className="text-center text-xs text-gray-500">&copy; 2024 EMASUPPLIES</p>
            </div>
        </div>
    )
}
